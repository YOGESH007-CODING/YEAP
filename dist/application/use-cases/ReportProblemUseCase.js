...
exports.ReportProblemUseCase = void 0;
...
class ReportProblemUseCase {
    ...
    async execute(userId, dto) {
        ...
        const now = new Date();
        const updatedProgress = await this.progressRepo.atomicFindAndUpdate(userId, problem.id, (current) => {
            const currentState = {
...
exports.ReportProblemUseCase = ReportProblemUseCase;
//# sourceMappingURL=ReportProblemUseCase.js.map